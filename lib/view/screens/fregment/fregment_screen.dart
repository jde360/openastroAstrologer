...
class FregmentScreen extends StatefulWidget {
  FregmentScreen({super.key});

  @override
  State<FregmentScreen> createState() => _FregmentScreenState();
}

class _FregmentScreenState extends State<FregmentScreen> {
