...
class AppConstant {
  //development
  final String  _devUrl ='http://192.168.1.12:7111/api/v1';
  ...
  String get provacyPolicy =>kDebugMode?_devPrivacyPolicy:_prodPrivacyPolicy;
  String get termAndConditions =>kDebugMode?_devTermAndCondition:_prodTermAndCondition;
}